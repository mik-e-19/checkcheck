#!/bin/sh
					...
					gcc -Wall -Wextra -Werror stupidity.c work/ex06/ft_convert_base.c work/ex06/main.c -o work/ex06/main
				
					echo building work/ex07/main_basic
					gcc -Wall -Wextra -Werror stupidity.c work/ex07/ft_split.c work/ex07/main_basic.c -o work/ex07/main_basic
				
					echo building work/ex07/main_junk
					gcc -Wall -Wextra -Werror stupidity.c work/ex07/ft_split.c work/ex07/main_junk.c -o work/ex07/main_junk
				
					echo building work/ex07/main_less
					gcc -Wall -Wextra -Werror stupidity.c work/ex07/ft_split.c work/ex07/main_less.c -o work/ex07/main_less
